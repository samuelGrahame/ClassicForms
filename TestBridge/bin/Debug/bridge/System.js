                ...
                OnClickServer: function (button) {
                    ...
                    if (!button.IsSendingEventNull()) {
                        ...
                        if (evArgs == null || evArgs.Cancel) {
                            ...
                            try {
                                jQuery.ajax({ contentType: evArgs.ContentType, data: evArgs.Data, dataType: evArgs.DataType, username: evArgs.Username, password: evArgs.Password, success: function (o, str, jq) {
                                    var $t;
