...
//                    throw new ArgumentException(Environment.GetResourceString("Serialization_MBRAsMBV", values));
//                }
...
//                throw new ArgumentNullException("serParser", Environment.GetResourceString("ArgumentNull_WithParamName", values));
//            }
...
//        {
//            StringBuilder builder = StringBuilderCache.Acquire(10);
//            builder.Append("[");
...
//            throw new SerializationException(Environment.GetResourceString("Serialization_XMLElement", values));
//        }
...
//                throw new SerializationException(Environment.GetResourceString("Serialization_ArrayType", values));
//            }
...
//            throw new SerializationException(Environment.GetResourceString("Serialization_ParseError", values));
//        }
...
//                        {
//                            object[] values = new object[] { pr.PRname };
//                            throw new SerializationException(Environment.GetResourceString("Serialization_TypeMissing", values));
//                        }
//                        this.ParseString(pr, parentPr);
...
//                    throw new SerializationException(Environment.GetResourceString("Serialization_TopObjectInstantiate", values));
//                }
//                if (pr.PRobjectPositionEnum == InternalObjectPositionE.Top)
//                {
//                    this.TopObject = pr.PRnewObj;
