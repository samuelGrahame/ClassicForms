...
//#endif
    {
        ...
        internal Object Deserialize(Stream serializationStream, HeaderHandler handler, bool fCheck)
        {
            ...
            {
                throw new ArgumentNullException("serializationStream", EnvironmentV2.GetResourceString("ArgumentNull_WithParamName", serializationStream));
            }
           ...
           // SerTrace.Log(this, "Deserialize Entry");
            ...
            return sor.Deserialize(handler, new __BinaryParser(serializationStream, sor), fCheck, false, null);
        ...
        internal static TypeInformation GetTypeInformation(Type type)
        {
            lock (typeNameCache)
            {
                ...
                if (!typeNameCache.TryGetValue(type, out typeInformation))
                {
                    ...
                    string assemblyName = type.Assembly.FullName;//  FormatterServices.GetClrAssemblyName(type, out hasTypeForwardedFrom);
                    typeInformation = new TypeInformation(type.FullName, assemblyName, false);
