...
namespace System.Runtime.Serialization.Formatters.Binary
{
    internal sealed class BinaryMethodReturn : IStreamable
    {
        ...
        //TODO:private static object instanceOfVoid = FormatterServices.GetUninitializedObject(Converter.typeofSystemVoid);
        ...
        public void Read(__BinaryParser input)
        {
            ...
            {
                //this.returnValue = instanceOfVoid; TODO
            }
            ...
            if (IOUtil.FlagTest(this.messageEnum, MessageEnum.ContextInline))
            {
                ...
                {
                    RemotingData = new { LogicalCallID = this.scallContext }
                };
